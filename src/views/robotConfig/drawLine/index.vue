...
const configRules = reactive({
  minimum_point_spread: [
    { required: true, message: "最小点差不能为空", trigger: "blur" },
    {
  ...
  transaction_interval_ms: [
    { required: true, message: "成交间隔不能为空", trigger: "blur" },
  ],
  minimum_volume: [
  ...
  maximum_volume: [
    { required: true, message: "最大交易量不能为空", trigger: "blur" },
    {
      validator: (rule, value, callback) => {
        if (value <= 0) {
  ...
  large_probability: [
    { required: true, message: "大额概率不能为空", trigger: "blur" },
  ],
  large_multiplier: [
    { required: true, message: "大额乘数不能为空", trigger: "blur" },
  ],
});
            ...
            >
              <el-row :gutter="20">
                ...
                <el-col :span="8">
                  <el-form-item
                    label="成交间隔（ms）"
                    prop="transaction_interval_ms"
                  >
                    <el-input-number
                      v-model="robotConfig.transaction_interval_ms"
                      :step="1"
                      min="0"
                      :max="999999999"
              ...
              <el-row :gutter="20">
                ...
                <el-col :span="8">
                  <el-form-item label="大额概率%" prop="large_probability">
                    <el-input-number
                      v-model="robotConfig.large_probability"
                      min="0"
                      :max="100"
                      controls-position="right"
                    />
                ...
                <el-col :span="8">
                  <el-form-item label="大额乘数" prop="large_multiplier">
                    <el-input-number
                      v-model="robotConfig.large_multiplier"
                      min="0"
                      :max="999999999"
                      controls-position="right"
                    />
