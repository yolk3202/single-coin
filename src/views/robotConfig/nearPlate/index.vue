...
const configRules = reactive({
  layer_count: [
    { required: true, message: "近盘层数不能为空", trigger: "blur" },
    {
  ...
  sell_order_price_spread: [
    { required: true, message: "卖盘盘口价差", trigger: "blur" },
    {
      validator: (rule, value, callback) => {
        if (value <= 0) {
  ...
  buy_order_price_spread: [
    { required: true, message: "买盘盘口价差", trigger: "blur" },
    {
      validator: (rule, value, callback) => {
        if (value <= 0) {
  ...
  sell_order_step_length: [
    { required: true, message: "卖盘步长", trigger: "blur" },
    {
      validator: (rule, value, callback) => {
        if (value <= 0) {
  ...
  buy_order_step_length: [
    { required: true, message: "买盘步长", trigger: "blur" },
    {
      validator: (rule, value, callback) => {
        if (value <= 0) {
  ...
  minimum_point_spread: [
    { required: true, message: "最小点差", trigger: "blur" },
    {
      validator: (rule, value, callback) => {
        if (value <= 0) {
  ...
  minimum_volume: [
    { required: true, message: "最小量", trigger: "blur" },
    {
      validator: (rule, value, callback) => {
        if (value <= 0) {
  ...
  maximum_volume: [
    { required: true, message: "最大量", trigger: "blur" },
    {
      validator: (rule, value, callback) => {
        if (value <= 0) {
  ...
  update_frequency_ms: [
    { required: true, message: "更新频率", trigger: "blur" },
    {
      validator: (rule, value, callback) => {
        if (value < 100) {
  ...
  quote_expiration_time_ms: [
    { required: true, message: "报价过期时间", trigger: "blur" },
    {
      validator: (rule, value, callback) => {
        if (value < 100) {
            ...
            >
              <el-row :gutter="20">
                <el-col :span="8">
                  <el-form-item label="近盘层数" prop="layer_count">
                    <el-input-number
                      v-model="robotConfig.layer_count"
                      :step="1"
                      min="0"
                      :max="999999999"
                ...
                <el-col :span="8">
                  <el-form-item
                    label="卖盘盘口价差"
                    prop="sell_order_price_spread"
                  >
                    <el-input
                      v-model="robotConfig.sell_order_price_spread"
                      type="number"
                      step="0.01"
                      min="0"
                      max="999999999"
                ...
                <el-col :span="8">
                  <el-form-item
                    label="买盘盘口价差"
                    prop="buy_order_price_spread"
                  >
                    <el-input
                      v-model="robotConfig.buy_order_price_spread"
                      type="number"
                      step="0.01"
                      min="0"
                      max="999999999"
              ...
              <el-row :gutter="20">
                <el-col :span="8">
                  <el-form-item label="卖盘步长" prop="sell_order_step_length">
                    <el-input
                      v-model="robotConfig.sell_order_step_length"
                      type="number"
                      step="0.01"
                      min="0"
                      max="999999999"
                ...
                <el-col :span="8">
                  <el-form-item label="买盘步长" prop="buy_order_step_length">
                    <el-input
                      v-model="robotConfig.buy_order_step_length"
                      type="number"
                      step="0.01"
                      min="0"
                      max="999999999"
                ...
                <el-col :span="8">
                  <el-form-item label="最小点差" prop="minimum_point_spread">
                    <el-input
                      v-model="robotConfig.minimum_point_spread"
                      type="number"
                      step="0.01"
                      min="0"
                      max="999999999"
              ...
              <el-row :gutter="20">
                <el-col :span="8">
                  <el-form-item label="最小量" prop="minimum_volume">
                    <el-input
                      v-model="robotConfig.minimum_volume"
                      type="number"
                      step="0.01"
                      min="0"
                      max="999999999"
                ...
                <el-col :span="8">
                  <el-form-item label="最大量" prop="maximum_volume">
                    <el-input
                      v-model="robotConfig.maximum_volume"
                      type="number"
                      step="0.01"
                      min="0"
                      max="999999999"
                ...
                <el-col :span="8">
                  <el-form-item
                    label="更新频率 (ms)"
                    prop="update_frequency_ms"
                  >
                    <el-input-number
                      v-model="robotConfig.update_frequency_ms"
                      :step="20"
                      min="0"
                      :max="99999999"
                      controls-position="right"
              ...
              <el-row :gutter="20">
                <el-col :span="8">
                  <el-form-item
                    label="报价过期时间 (ms)"
                    prop="quote_expiration_time_ms"
                  >
                    <el-input-number
                      v-model="robotConfig.quote_expiration_time_ms"
                      :step="20"
                      min="0"
                      :max="99999999"
                      controls-position="right"
                ...
                <el-col :span="8">
                  <el-form-item label="买盘市价因子（%）">
                    <el-input-number
                      v-model="robotConfig.buyside_market_impact"
                      :step="1"
                      min="0"
                      :max="100"
                      controls-position="right"
                ...
                <el-col :span="8">
                  <el-form-item label="卖盘市价因子（%）">
                    <el-input-number
                      v-model="robotConfig.sellside_market_impact"
                      :step="1"
                      min="0"
                      :max="100"
                      controls-position="right"
